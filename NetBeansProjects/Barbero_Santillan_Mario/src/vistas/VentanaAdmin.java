...
public class VentanaAdmin extends javax.swing.JFrame {
    ...
    Empresa miEmpresa;
    Usuario validado;
    PnAltaLineas pAltaLineas;
    PnBajaLineas pBajaLineas;
    ...
    private void miAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miAltaActionPerformed
        quitarPaneles();
        pAltaLineas = new PnAltaLineas(miEmpresa);
        getContentPane().add(pAltaLineas);
        pack();
    ...
    private void miBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miBajaActionPerformed
        quitarPaneles();
        pBajaLineas = new PnBajaLineas(miEmpresa);
        getContentPane().add(pBajaLineas);
        pack();
    ...
    private void quitarPaneles() {
        try {
            this.remove(pAltaLineas);
        } catch (Exception e) {
        }
        try {
            this.remove(pBajaLineas);
        } catch (Exception e) {
        }
    }
